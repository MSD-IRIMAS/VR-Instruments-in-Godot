...
## An extention of the Hand script for XR Controllers.
##
## Like the Hand script, manages the speed detection of the hand and the pluse detection system. [br]
## Unlike the Hand script, also manages the hitbox change when the hand shape changes. 
